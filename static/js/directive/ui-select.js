  ...
  .directive('uiSelect',
    ...
    return {
      ...
      templateUrl: function(tElement, tAttrs) {
        ...
        return '/view/common/' + theme + (angular.isDefined(tAttrs.multiple) ? '/select-multiple.tpl.html' : '/select.tpl.html');
      },
      replace: true,
      transclude: true,
  ...
  .directive('uiSelectChoices',
    ...
    return {
      ...
      templateUrl: function(tElement) {
        ...
        return '/view/common/' + theme + '/choices.tpl.html';
      },
  ...
  .directive('uiSelectMatch', ['uiSelectConfig', function(uiSelectConfig) {
    return {
      ...
      templateUrl: function(tElement) {
        ...
        return '/view/common/' + theme + (multi ? '/match-multiple.tpl.html' : '/match.tpl.html');
      },
